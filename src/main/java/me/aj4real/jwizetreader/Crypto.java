...
public class Crypto {
    ...
    public static final byte[] trimmedUserKey = {
    ...
    private static final byte[] shuffleBytes = {
    ...
    public static short wzVersionHeader64bitStart = 777;
    public static byte[] defaultAesKeyValue = {
            (byte) 0xC6, (byte) 0x50, (byte) 0x53, (byte) 0xF2, (byte) 0xA8, (byte) 0x42, (byte) 0x9D, (byte) 0x7F,
            (byte) 0x77, (byte) 0x09, (byte) 0x1D, (byte) 0x26, (byte) 0x42, (byte) 0x53, (byte) 0x88, (byte) 0x7C
    };

    public static final byte[] wzGmsIv = new byte[]{0x4D, 0x23, (byte) 0xC7, 0x2B};
    ...
    public static int rotateRight(int value, byte bit) {
        return value << bit;
    }
    ...
    public static byte[] shuffle(byte inputByte, byte[] start) {
        ...
        b ^= start[2];
        start[2] = b;
        a += shuffleBytes[inputByte];
        start[3] = a;
        c = (start[0] + start[1] * 0x100 + start[2] * 0x10000 + start[3] * 0x1000000);
        d = c;
        c >>= (byte) 0x1D;
        d <<= (byte) 0x03;
        c |= d;
        start[0] = (byte) (c % (byte) 0x100);
        c /= 0x100;
        start[1] = (byte) (c % (byte) 0x100);
        c /= 0x100;
        start[2] = (byte) (c % (byte) 0x100);
        start[3] = (byte) (c % (byte) 0x100);
        return start;
    }
